...
- 🐛 🔧 align update-features workflow with devcontainer-features canonical stub (#37)
...
- 🐛 🔧 remove invalid workflows permission from update-features.yml (#35)
- 🐛 🔧 track moving release-promote/scripts tags in release-prod workflow (#36)
...
- ✨ declare tomgrv/scripts sibling deps as peerDependencies (#34)
